            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                <div class="card overflow-hidden">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="p-2" id="submit_form">
                            <form class="form-horizontal" action="{{route('admin.login')}}" method="post" id="form">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mt-4 text-center">
                                    <a href="{{route('admin.reset-password-form')}}" class="text-muted"><i class="mdi mdi-lock me-1"></i> Forgot your password?</a>
                                </div>
                            </form>
                        </div>
