...
@section('head-title-2')
    <li class="breadcrumb-item"><a href="{{route('expanse.page')}}">Expanse Report</a></li>
@endsection
@section('body')
    <div class="card-header">
        <div class="row">
            ...
            <div class="col-lg-2">
                <form target="_blank" action="{{route('expanse.by.date')}}" method="POST">
                    @csrf
        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive" id="table">
                    @include('admin.report.expanse.table')
                </div>
            </div>
        </div>
    </div>
@endsection
@section('js')
    @include('admin.report.expanse.script')
@endsection
