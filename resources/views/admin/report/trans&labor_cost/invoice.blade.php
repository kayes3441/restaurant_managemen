            ...
            <div class="as-invoice invoice_style1">
                <div class="download-inner" id="download_section">
                    <header class="as-header header-layout1">
                        ...
                        <div class="header-bottom">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto"><p class="invoice-number me-4"><b>Transport & Labor Cost</b></p>
                                </div>
                                <div class="col-auto"><p class="invoice-date"><b>Date: </b>{{date('d-m-Y')}}</p></div>
                            </div>
                        </div>
                    </header>
                    ...
                    <table class="invoice-table">
                        ...
                        <tbody>
{{--                        @if($all_cost->purchase_type=='Debit')--}}
                        <tr>
                            <td>Purchase</td>
                            <td>{{dateFormat($all_cost->created_at,'d-m-Y')}}</td>
                            <td>{{$all_cost->purchase_type=='Debit' ? $all_cost->name : $all_cost->supplier->name}}</td>
                            <td>{{$all_cost->purchase_type=='Debit' ? $all_cost->mobile : $all_cost->supplier->mobile}}</td>
                        </tr>
                        </tbody>
                    </table>
                    <div class="row justify-content-between">
                        ...
                        <div class="col-auto">
                            <table class="total-table">
                                ...
                                <tr>
                                    <th>Labor Cost</th>
                                    <td>{{$all_cost->labor_cost}}</td>
                                </tr>
                                <tr>
                                    <th>Transport Cost</th>
                                    <td>{{$all_cost->transport_cost}}</td>
                                </tr>
                                <tr>
                                    <th></th>
                                    <td></td>
                                ...
                                <tr>
                                    <th>Total</th>
                                    <td>{{$all_cost->labor_cost+$all_cost->transport_cost}}</td>
                                </tr>
                ...
                <div class="invoice-buttons">
                    ...
                    <a id="download_btn" class="download_btn"  href="{{route('trans.and.labor.cost.page')}}">
