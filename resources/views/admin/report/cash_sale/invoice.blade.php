...
<div id="print" class="hidden-print">
    ...
    <br>
    <a class="button2" href="{{route('cash.sale.page')}}" ><i class="fa fa-arrow-left"> Back</i> </a>
    <br>
    <button class="button1"><i class="fa fa-times-circle"></i> Close</button>
</div>
<div id="invoice-POS">
    ...
    <p style="margin-top: 1px;margin-bottom: 1px ;text-align: center ;border-bottom: 1px dashed #EEE;" >Cash Sale Invoice</p>
