        ...
        <main>
            <div class="as-invoice invoice_style1">
                <div class="download-inner" id="download_section">
                    <header class="as-header header-layout1">
                        ...
                        <div class="header-bottom">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto"><p class="invoice-number me-4"><b>Cash Payment Invoice</b></p>
                                </div>
                                <div class="col-auto"><p class="invoice-date"><b>Date: </b>{{dateFormat($supplier_payment->created_at,'d-m-Y')}}</p></div>
                            </div>
                        </div>
                    </header>
                    ...
                    <table class="invoice-table">
                        ...
                        <tr>
                            ...
                            <td>{{$supplier_payment->supplier->mobile}}</td>
                            <td>{{$supplier_payment->past_balance}}</td>
                        </tr>
                        </tbody>
                    </table>
                    <div class="row justify-content-between">
                        ...
                        <div class="col-auto">
                            <table class="total-table">
                                ...
                                <tr>
                                    <th>Discount</th>
                                    <td>{{$supplier_payment->discount}}</td>
                                </tr>
                                <tr>
                                    <th>Payable</th>
                                    <td>{{$supplier_payment->new_balance}}</td>
                                </tr>
                                <tr>
                                    <th></th>
                                    <td></td>
                ...
                <div class="invoice-buttons">
                    ...
                    <a id="download_btn" class="download_btn"  href="{{route('supplier_pay.report.page')}}">
