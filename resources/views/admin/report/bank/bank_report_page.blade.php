...
@section('head-title-2')
    <li class="breadcrumb-item"><a href="{{route('bank.report.page')}}">Bank Report</a></li>
@endsection
@section('body')
    <div class="card-header">
        <div class="row">
            ...
            <div class="col-lg-2">
                <form target="_blank" action="{{route('get.info.bank')}}" method="POST">
                    @csrf
        ...
        <div class="card">
            <div class="card-body">
                <div id="table" class="table-responsive p-1">
                    @include('admin.report.bank.table')
                </div>
            </div>
        </div>
    </div>
@endsection
@section('js')
    @include('admin.report.bank.script')
@endsection
