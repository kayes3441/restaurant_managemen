        ...
        <main>
            <div class="as-invoice invoice_style1">
                <div class="download-inner" id="download_section">
                    <header class="as-header header-layout1">
                        ...
                        <div class="header-bottom">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto"><p class="invoice-number me-4"><b>Income Invoice</b></p>
                                </div>
                    ...
                    <table class="invoice-table">
                        ...
                        <tr>
                            ...
                            <td>{{dateFormat($income->created_at,'d-m-Y')}}</td>
                ...
                <div class="invoice-buttons">
                    ...
                    <a id="download_btn" class="download_btn"  href="{{route('income.report.page')}}">
