...
@section('head-title-2')
    <li class="breadcrumb-item"><a href="{{route('purchase.report.page')}}">Purchase Report</a></li>
@endsection
@section('body')
    ...
    <div class="card-header">
        <div class="row">
            ...
            <div class="col-lg-2">
                <form target="_blank" action="{{route('get.purchase.info.by.date')}}" method="POST">
                    @csrf
        ...
        <div class="card">
            <div class="card-body">
                <div id="table" class="table-responsive p-1">
                    @include('admin.report.purchase_report.table')
                </div>
            </div>
        </div>
    </div>
@endsection
@section('js')
    @include('admin.report.purchase_report.script')
@endsection
