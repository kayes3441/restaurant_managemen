...
<div id="print" class="hidden-print">
    ...
    <br>
    <a class="button2" href="{{route('add.sale')}}" ><i class="fa fa-arrow-left">Back</i> </a>
    <br>
</div>
<div id="invoice-POS">
    ...
    <p style="margin-top: 1px;margin-bottom: 1px ;text-align: center ;border-bottom: 1px dashed #EEE;" >INVOICE</p>
...
{{--    <h5 class="centered text-style">Restaurant Invoice</h5>--}}
{{--    @if($sale->sale_type=='Credit')--}}
{{--     <h6 class="centered">Credit Memo</h6>--}}
{{--     <h6 style="text-align:left;height: 0px;top: 0px;padding-left: 10px;margin-top:1px">Name:{{$sale->customer->name}}</h6>--}}
{{--     <h6 style="text-align:left;height: 0px;top: 0px;padding-left: 10px;margin-bottom:5px">Mobile:{{$sale->customer->mobile}}</h6>--}}
{{--    @elseif($sale->sale_type=='Cash')--}}
{{--    <h6 style="text-align:center;height: 0px;top: 0px;padding-left: 10px;margin-bottom:5px">Cash Memo</h6>--}}
{{--    @endif--}}
{{--    <table class="text">--}}
{{--        <thead>--}}
{{--        <tr>--}}
{{--            <th class="description">Name</th>--}}
{{--            <th class="quantity">Qry</th>--}}
...
{{--        <tr>--}}
{{--            <td class="description">{{$sale_item->food_name}}</td>--}}
{{--            <td class="quantity">{{$sale_item->quantity}}</td>--}}
{{--            <td class="price">{{$sale_item->quantity*$sale_item->price}}</td>--}}
{{--        </tr>--}}
{{--        @endforeach--}}
