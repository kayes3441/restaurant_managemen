    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="min-width: 800px">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="modal_title">Add Customer Form</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{route('create.customer')}}" method="POST" id="addForm">
                    @csrf
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-3">
                            <select class="form-control" name="balance_title" required>
                    ...
                    <div class="form-group row justify-content-end">
                        <div class="col-sm-9">
                            <div>
                                <button type="submit" class="btn btn-primary w-md">Create Customer Info</button>
                            </div>
                        </div>
                    </div>
                </form>
