        ...
        <main>
            <div class="as-invoice invoice_style1">
                    ...
                    <header class="as-header header-layout1">
                        ...
                        <div class="header-bottom">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto"><p class="invoice-number me-4"><b>Invoice No: </b>#{{$purchase->id}}</p>
                                </div>
                                <div class="col-auto"><p class="invoice-date"><b>Date: </b>{{dateFormat($purchase->created_at,'d-m-Y')}}</p></div>
                            </div>
                        </div>
                    </header>
                    <div class="row justify-content-between mb-4">
                        <div class="col-auto">
                            ...
                            <div class="invoice-left"><b>Invoiced To:</b>
                                <address>{{$purchase->name}}<br>{{$purchase->mobile}}<br>
                                </address>
                            </div>
                            @elseif($purchase->purchase_type =='Credit')
                                <div class="invoice-left"><b>Invoiced To:</b>
                                    <address>{{$purchase->supplier->name}}<br>{{$purchase->supplier->mobile}}<br>{{$purchase->supplier->address}}
                                    </address>
                                </div>
                            @endif
                        </div>
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-auto">
                            <table class="total-table">
                                ...
                                <tr>
                                    <th>Total:</th>
                                    <td>{{$purchase->total_amount+$purchase->labor_cost+$purchase->transport_cost}}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                ...
                <div class="invoice-buttons">
                    ...
                    <a id="download_btn" class="download_btn"  href="{{route('add.purchase')}}">
