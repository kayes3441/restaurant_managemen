...
use App\Http\Controllers\Admin\FoodRecipeController;
...
Route::any('edit-food-recipe/{id}',[
    'uses'=>'App\Http\Controllers\Admin\FoodRecipeController@editFoodRecipe',
    'as'=>'edit-food-recipe'
]);
Route::any('update-recipe/{id}',[
    'uses'=>'App\Http\Controllers\Admin\FoodRecipeController@updateRecipe',
    'as'=>'update-recipe'
]);
Route::any('delete-recipe',[
    'uses'=>'App\Http\Controllers\Admin\FoodRecipeController@deleteRecipe',
    'as'=>'delete-recipe'
]);
